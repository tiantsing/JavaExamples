package com.tiantsing.frist.demoF.rabbitMQ;
 ...
 * Key:路由关键字,exchange根据这个关键字进行消息投递。 vhost:虚拟主机,一个broker里可以有多个vhost，用作不同用户的权限分离。
...
public class RabbitConfig {
	...
	public ConnectionFactory connectionFactory() {
		...
		connectionFactory.setVirtualHost("tiantsing");
